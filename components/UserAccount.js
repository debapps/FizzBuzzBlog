...
export default function UserAccount() {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-10 mb-32">
      <h2 className="text-4xl mb-5 text-indigo-500 hover:text-purple-500">
        Admin User Details
      </h2>
      ...
      <section className="flex flex-wrap md:flex-row justify-between items-center w-[90%] md:w-1/2 space-x-20 bg-gray-100 border-2 hover:border-indigo-500 m-2 p-5 rounded-lg text-indigo-500 hover:text-purple-500">
        <h3 className="text-lg md:text-2xl font-bold">Email:</h3>
        <p className="text-sm md:text-xl">{email}</p>
      </section>
      <section className="flex flex-wrap md:flex-row justify-between items-center w-[90%] md:w-1/2 space-x-20 bg-gray-100 border-2 hover:border-indigo-500 m-2 p-5 rounded-lg text-indigo-500 hover:text-purple-500">
        <h3 className="text-lg md:text-2xl font-bold">Sex:</h3>
        <p className="text-sm md:text-xl">{gender}</p>
      </section>
      <section className="flex flex-wrap md:flex-row justify-between items-center w-[90%] md:w-1/2 space-x-20 bg-gray-100 border-2 hover:border-indigo-500 m-2 p-5 rounded-lg text-indigo-500 hover:text-purple-500">
        <h3 className="text-lg md:text-2xl font-bold">Creation Date:</h3>
        <p className="text-sm md:text-xl">{userCreationDate}</p>
      </section>
    </div>
  );
}
